...
<head>
    ...
    <link href="{{ asset('adminstyle/css/sb-admin-2.css') }}" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Deshbord <sup></sup></div>
            </a>
    ...
    <script src="{{ asset('addminstyle/js/sb-admin-2.min.js') }}"></script>
    <!-- Page level plugins -->
